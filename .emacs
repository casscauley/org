...
;; don't let electric-pair-mode mangle pasted text
(when (boundp 'electric-pair-mode-inhibit-predicates)
  (add-to-list 'electric-pair-mode-inhibit-predicates
               (lambda (c) (eq last-command 'yank))))
...
(custom-set-variables
 ...
 '(package-selected-packages '(markdown-mode php-mode vue-mode rjsx-mode))
